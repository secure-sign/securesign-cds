...
public class SgxEnclave implements Runnable {
  ...
  private static native void nativeServerStart(long enclaveId, long stateHandle, int maxAbPhones) throws SgxException;
  private static native void nativeServerCall(long enclaveId, long stateHandle, int abPhoneCount, byte[] msg_data, byte[] msg_iv, byte[] msg_mac, byte[] msg_ticket, NativeServerReplyCallback callback) throws SgxException;
